...
CONFIG = {
    ...
    # Data paths
    'INPUT_CSV': 'pointwise_output/gaze_important_features_pointwise.csv',
...
def load_and_prepare_data(filepath):
    ...
    print("\n" + "="*80)
    print("POINTWISE MODEL - GAZE IMPORTANT FEATURES (Random Forest Regressor)")
    print("="*80)
...
def train_and_evaluate_model(X, y, config):
    ...
    output_file = f'{output_dir}/importance_gaze_important_features_pointwise.csv'
...
def main():
    ...
    print("\n" + "="*80)
    print("POINTWISE MODEL (GAZE IMPORTANT FEATURES) TRAINING COMPLETE")
    print("="*80 + "\n")
