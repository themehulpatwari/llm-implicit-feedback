...
CONFIG = {
    ...
    # Data paths
    'INPUT_CSV': 'pointwise_output/important_features_compare_pointwise.csv',
    #'INPUT_CSV': 'pointwise_output/important_features_gaze_compare_pointwise.csv',
    #'INPUT_CSV': 'pointwise_output/important_features_mouse_compare_pointwise.csv',
...
def train_and_evaluate_model(X, y, config):
    ...
    output_file = f'{output_dir}/importance_features_compare_pointwise.csv'
...
def generate_oof_labels(X, y, df_original, config, output_filename):
    ...
    # Save
    output_dir = 'compare_pointwise_labeled_output'
    os.makedirs(output_dir, exist_ok=True)
...
def main():
    ...
    # Generate OOF labels
    generate_oof_labels(X, y, df_original, CONFIG, 'important_features_compare_pointwise_labeled.csv')
