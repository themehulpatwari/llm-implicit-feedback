...
CONFIG = {
    ...
    # Data paths
    'INPUT_CSV': 'pairwise_output/base+extracted+all_metrics+bert_pairwise.csv',
...
def load_and_prepare_data(filepath, config):
    ...
    print("Dataset: base+extracted+all_metrics+bert")
    print("="*80)
...
def train_and_evaluate_model(X, y, config):
    ...
    output_file = f'{output_dir}/importance_base_extracted_all_metrics+bert_pairwise.csv'
...
def main():
    ...
    # Generate OOF labels
    generate_oof_labels(X, y, df_original, CONFIG, 'base_extracted_all_metrics+bert_pairwise_labeled.csv')
