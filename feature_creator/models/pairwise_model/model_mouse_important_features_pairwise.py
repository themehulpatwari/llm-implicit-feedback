...
CONFIG = {
    ...
    # Data paths
    'INPUT_CSV': 'pairwise_output/new_mouse_important_features_pairwise.csv',
...
def load_and_prepare_data(filepath):
    ...
    print("\n" + "="*80)
    print("PAIRWISE MODEL - MOUSE IMPORTANT FEATURES (Random Forest Classifier)")
    print("="*80)
...
def train_and_evaluate_model(X, y, config):
    ...
    output_file = f'{output_dir}/importance_mouse_important_features_pairwise.csv'
...
def main():
    ...
    # Generate OOF labels
    #generate_oof_labels(X, y, df_original, CONFIG, 'mouse_important_features_pairwise_labeled.csv')
    generate_oof_labels(X, y, df_original, CONFIG, 'temp.csv')

    print("\n" + "="*80)
    print("PAIRWISE MODEL (MOUSE IMPORTANT FEATURES) TRAINING COMPLETE")
    print("="*80 + "\n")
