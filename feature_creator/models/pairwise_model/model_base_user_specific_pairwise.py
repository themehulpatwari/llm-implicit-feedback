...
Dataset: base+user_specific (includes top 5 users as binary features)
...
CONFIG = {
    ...
    # Data paths
    'INPUT_CSV': 'pairwise_output/base+user_specific_pairwise.csv',
...
def load_and_prepare_data(filepath):
    ...
    print("Dataset: base+user_specific")
    print("="*80)
...
def train_and_evaluate_model(X, y, config):
    ...
    output_file = f'{output_dir}/importance_base_user_specific_pairwise.csv'
...
def main():
    ...
    # Generate OOF labels
    generate_oof_labels(X, y, df_original, CONFIG, 'base_user_specific_pairwise_labeled.csv')
